...
export function percent(px, from) {
    return (px / from) * 100;
}
...
export function math(num, numTwo) {
    return numTwo / num;
}
export const adaptiveValue = (property, startSizePx, minSizePx, keepSize = 0, widthFromPx = 1200, widthToPx = 320) => {
